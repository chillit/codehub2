                  ...
                  BottomNavigationBarItem(
                    ...
                    icon: IconButton(
                      icon: _currentIndex == 1
                          ? Image.asset("assets/images/kz/shitBez.png", width:50)
                  ...
                  BottomNavigationBarItem(
                    ...
                    icon: IconButton(
                      icon: _currentIndex == 2
                          ? Image.asset("assets/images/kz/profile_kz.png", width: 50)
                          : Image.asset("assets/images/kz/profile_kzBez.png", width: 40),
